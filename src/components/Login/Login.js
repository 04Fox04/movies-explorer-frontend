            ...
            <section className="login">
                <div className="login__container">
                    ...
                    <form id="form" className="login__form" noValidate>
                        ...
                        <input name="email" className="login__input" id="email-input" type="email" required placeholder="pochta@yandex.ru"/>
                        <span className="login__input-error"></span>
                        <div className="login__border"></div>
                        <label className="login__label">Пароль</label>
                        <input name="password" className="login__input" id="password-input" type="password" required placeholder="••••••••••••••" />
                        <span className="login__input-error"></span>
                        <div className="login__border"></div>
