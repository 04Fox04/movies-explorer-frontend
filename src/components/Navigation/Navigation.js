...
function Navigation() {
    ...
    return (
        <div className="header-lite">
            <div className="header__button-container_lite">
                ...
                <div className="header__movies-container">
                    ...
                    <NavLink to="/saved-movies" className={({ isActive }) => isActive ? "header__button-saved_movies" : "header__button-saved_movies_active"}>Сохраненные фильмы</NavLink>
                </div>
