                ...
                <div className="profile__container">
                    ...
                    <form id="form" className="profile__form">
                        <label className="profile__label"> Имя
                            <input name="name" className="profile__input" id="name-input" type="text" minLength={2} required placeholder="имя"/>
                            <span className="profile__input-error"></span>
                        </label>
                        <div className="profile__border"></div>
                        <label className="profile__label">E-mail
                            <input name="email" className="profile__input" id="email-input" type="email" minLength={2} required placeholder="email"/>
                            <span className="profile__input-error"></span>
                        </label>
